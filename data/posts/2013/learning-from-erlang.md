...
Which looks suprisingly well and reminds me that recursion is underused in JavaScript (due its missing [tail call optimization](http://en.wikipedia.org/wiki/Tail_call)).
